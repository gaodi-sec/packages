...
void main() {
  ...
  testWidgets(
      ...
      (WidgetTester tester) async {
    final List<RenderAutoVectorGraphic> renderAutoVectorGraphic = List.generate(
      3,
      (index) => RenderAutoVectorGraphic(
        pictureInfo,
        'test_$index',
        null,
        1.0,
    ...
    for (final renderVectorGraphic in renderAutoVectorGraphic) {
      renderVectorGraphic.layout(BoxConstraints.tight(const Size(50, 50)));
    }
